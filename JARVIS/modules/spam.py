...
async def pspam(event):
    if event.sender_id in SUDO_USERS:
        if event.chat_id in GROUP:
            await event.reply("» YE GROUP MOON KE UNDER MAI HAI ISLEYE ISME PSPAM NHI HOGA...")
        else:
            try:
